	...
	public class NodeGUIUtility {
		...
		public static Texture2D inputPointTex {
			get {
				if(NodeSingleton.s.inputPointTex == null) {
					NodeSingleton.s.inputPointTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_INPUT_BG);
				}
		...
		public static Texture2D outputPointTex {
			get {
				if(NodeSingleton.s.outputPointTex == null) {
					NodeSingleton.s.outputPointTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_OUTPUT_BG);
				}
		...
		public static Texture2D enablePointMarkTex {
			get {
				if(NodeSingleton.s.enablePointMarkTex == null) {
					NodeSingleton.s.enablePointMarkTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_CONNECTIONPOINT_ENABLE);
				}
		...
		public static Texture2D inputPointMarkTex {
			get {
				if(NodeSingleton.s.inputPointMarkTex == null) {
					NodeSingleton.s.inputPointMarkTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_CONNECTIONPOINT_INPUT);
				}
		...
		public static Texture2D outputPointMarkTex {
			get {
				if(NodeSingleton.s.outputPointMarkTex == null) {
					NodeSingleton.s.outputPointMarkTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_CONNECTIONPOINT_OUTPUT);
				}
		...
		public static Texture2D outputPointMarkConnectedTex {
			get {
				if(NodeSingleton.s.outputPointMarkConnectedTex == null) {
					NodeSingleton.s.outputPointMarkConnectedTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_CONNECTIONPOINT_OUTPUT_CONNECTED);
				}
		...
		private class NodeSingleton {
			...
			public NodeSingleton() {				
				nodeAqua = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_AQUA);
				nodeAquaOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_AQUA_ON);
				nodeAquaHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_AQUA_HIGHLIGHT);
				nodeGrey = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREY);
				nodeGreyOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREY_ON);
				nodeGreyHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREY_HIGHLIGHT);
				nodeBlue = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_BLUE);
				nodeBlueOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_BLUE_ON);
				nodeBlueHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_BLUE_HIGHLIGHT);
				nodeOrange = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_ORANGE);
				nodeOrangeOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_ORANGE_ON);
				nodeOrangeHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_ORANGE_HIGHLIGHT);
				nodeRed = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED);
				nodeRedOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED_ON);
				nodeRedHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED_HIGHLIGHT);
				nodeRed = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED);
				nodeRedOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED_ON);
				nodeRedHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_RED_HIGHLIGHT);
				nodeYellow = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_YELLOW);
				nodeYellowOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_YELLOW_ON);
				nodeYellowHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_YELLOW_HIGHLIGHT);
				nodeGreen = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREEN);
				nodeGreenOn = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREEN_ON);
				nodeGreenHighlight = AssetDatabase.LoadAssetAtPath<Texture2D>(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_NODE_GREEN_HIGHLIGHT);
			}
