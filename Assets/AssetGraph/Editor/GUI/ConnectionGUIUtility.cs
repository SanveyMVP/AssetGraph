		...
		public static Texture2D connectionArrowTex {
			get {
				...
				if( ConnectionGUISingleton.s.connectionArrowTex == null ) {
					ConnectionGUISingleton.s.connectionArrowTex = AssetBundleGraphEditorWindow.LoadTextureFromFile(AssetBundleGraphSettings.AssetGraphRelativePaths.RESOURCE_ARROW);
				}
